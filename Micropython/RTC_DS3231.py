...
# modified for Raspi Pico
#
# Author: Sebastian Maerker, modified by JC Feltes
# License: mit
# 
...
class DS3231:
    ...
    def __init__(self, i2c, i2cClockPin, i2cDataPin):
        ...
        self.i2cVar = machine.I2C(i2c, scl=self.sclPin, sda=self.sdaPin)
